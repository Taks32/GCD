...
おそらくみんな知っているユークリッドの互除法という「方法」がある。
ユークリッドの互除法は次の等式に基づく。
...
Binary GCD の計算量の解析は通常のユークリッドの互除法よりも簡単である。
まずは漸化式を適用する回数を数えよう。
...
今日の演習課題
\begin{enumerate}
\item 上記のプログラムを \texttt{gcd.c} に書き写せ。
